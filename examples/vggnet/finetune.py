...
# Create training directories
    ...
    # Placeholders
    x = tf.placeholder(tf.float32, [FLAGS.batch_size, 224, 224, 3])# The placeholder of image format
    ...
    train_preprocessor = BatchPreprocessor(dataset_file_path=FLAGS.training_file, num_classes=FLAGS.num_classes,output_size=[224, 224], horizontal_flip=True, shuffle=True, multi_scale=multi_scale)
    ...
    with tf.Session() as sess:
        ...
        for epoch in range(FLAGS.num_epochs):
            ...
            # Epoch completed , start vaildation
